...
pub const LOS_HOOK_TYPE_MEM_INIT: u32 = 1;   // 原来未定义
pub const LOS_HOOK_TYPE_MEM_ALLOC: u32 = 2;  // 原来未定义
#[repr(C)]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to create a mutex. A mutex handle is assigned to muxHandle when the mutex is created successfully."]
    #[doc = " Return LOS_OK on creating successful, return specific error code otherwise."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The total number of mutexes is pre-configured. If there are no available mutexes, the mutex creation fails.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param muxHandle   [OUT] Handle pointer of the successfully created mutex. The value of handle should be in"]
    #[doc = " [0, LOSCFG_BASE_IPC_MUX_LIMIT - 1]."]
    #[doc = ""]
    #[doc = " @retval #LOS_ERRNO_MUX_PTR_NULL           The muxHandle pointer is NULL."]
    #[doc = " @retval #LOS_ERRNO_MUX_ALL_BUSY           No available mutex."]
    #[doc = " @retval #LOS_OK                           The mutex is successfully created."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_mux.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_MuxDelete"]
    pub fn LOS_MuxCreate(muxHandle: *mut UINT32) -> UINT32;
}
extern "C" {
    #[doc = " @ingroup los_mux"]
    #[doc = " @brief Delete a mutex."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to delete a specified mutex. Return LOS_OK on deleting successfully, return specific error code"]
    #[doc = " otherwise."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specific mutex should be created firstly.</li>"]
    #[doc = " <li>The mutex can be deleted successfully only if no other tasks pend on it.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param muxHandle   [IN] Handle of the mutex to be deleted. The value of handle should be in"]
    #[doc = " [0, LOSCFG_BASE_IPC_MUX_LIMIT - 1]."]
    #[doc = ""]
    #[doc = " @retval #LOS_ERRNO_MUX_INVALID            Invalid handle or mutex in use."]
    #[doc = " @retval #LOS_ERRNO_MUX_PENDED             Tasks pended on this mutex."]
    #[doc = " @retval #LOS_OK                           The mutex is successfully deleted."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_mux.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_MuxCreate"]
    pub fn LOS_MuxDelete(muxHandle: UINT32) -> UINT32;
}
extern "C" {
    #[doc = " @ingroup los_mux"]
    #[doc = " @brief Wait to lock a mutex."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to wait for a specified period of time to lock a mutex."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specific mutex should be created firstly.</li>"]
    #[doc = " <li>The function fails if the mutex that is waited on is already locked by another thread when the task scheduling"]
    #[doc = " is disabled.</li>"]
    #[doc = " <li>Do not wait on a mutex during an interrupt.</li>"]
    #[doc = " <li>The priority inheritance protocol is supported. If a higher-priority thread is waiting on a mutex, it changes"]
    #[doc = " the priority of the thread that owns the mutex to avoid priority inversion.</li>"]
    #[doc = " <li>A recursive mutex can be locked more than once by the same thread.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param muxHandle    [IN] Handle of the mutex to be waited on.  The value of handle should be"]
    #[doc = " in [0, LOSCFG_BASE_IPC_MUX_LIMIT - 1]."]
    #[doc = " @param timeout      [IN] Waiting time. The value range is [0, LOS_WAIT_FOREVER](unit: Tick)."]
    #[doc = ""]
    #[doc = " @retval #LOS_ERRNO_MUX_INVALID            The mutex state (for example, the mutex does not exist or is not in use)"]
    #[doc = "                                           is not applicable for the current operation."]
    #[doc = " @retval #LOS_ERRNO_MUX_UNAVAILABLE        The mutex fails to be locked because it is locked by another thread and"]
    #[doc = " a period of time is not set for waiting for the mutex to become available."]
    #[doc = " @retval #LOS_ERRNO_MUX_IN_INTERR        The mutex is being locked during an interrupt."]
    #[doc = " @retval #LOS_ERRNO_MUX_PEND_IN_LOCK       The mutex is waited on when the task scheduling is disabled."]
    #[doc = " @retval #LOS_ERRNO_MUX_TIMEOUT            The mutex waiting times out."]
    #[doc = " @retval #LOS_OK                           The mutex is successfully locked."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_mux.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_MuxCreate | LOS_MuxPost"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to release a specified mutex."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specific mutex should be created firstly.</li>"]
    #[doc = " <li>Do not release a mutex during an interrupt.</li>"]
    #[doc = " <li>If a recursive mutex is locked for many times, it must be unlocked for the same times to be released.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param muxHandle    [IN] Handle of the mutex to be released. The value of handle should be in"]
    #[doc = " [0, LOSCFG_BASE_IPC_MUX_LIMIT - 1]."]
    #[doc = ""]
    #[doc = " @retval #LOS_ERRNO_MUX_INVALID            The mutex state (for example, the mutex does not exist or is not in use"]
    #[doc = " or owned by other thread) is not applicable for the current operation."]
    #[doc = " @retval #LOS_ERRNO_MUX_IN_INTERR        The mutex is being released during an interrupt."]
    #[doc = " @retval #LOS_OK                           The mutex is successfully released."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_mux.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_MuxCreate | LOS_MuxPend"]
...
#[test]
fn bindgen_test_layout_LosMuxCB() {
    assert_eq!(
        ::std::mem::size_of::<LosMuxCB>(),
        40usize,
        concat!("Size of: ", stringify!(LosMuxCB))
    );
    assert_eq!(
        ::std::mem::align_of::<LosMuxCB>(),
        8usize,
        concat!("Alignment of ", stringify!(LosMuxCB))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosMuxCB>())).muxStat as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(LosMuxCB),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosMuxCB>())).muxCount as *const _ as usize },
        2usize,
        concat!(
            "Offset of field: ",
            stringify!(LosMuxCB),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosMuxCB>())).muxID as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(LosMuxCB),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosMuxCB>())).muxList as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(LosMuxCB),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosMuxCB>())).owner as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(LosMuxCB),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosMuxCB>())).priority as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(LosMuxCB),
...
extern "C" {
    #[doc = " @ingroup los_mux"]
    #[doc = " @brief Initializes the mutex."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to initializes the mutex."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>None.</li>"]
    #[doc = " </ul>"]
...
#[doc = " Structure of the block for queue information query"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[test]
fn bindgen_test_layout_tagQueueInfo() {
    assert_eq!(
        ::std::mem::size_of::<tagQueueInfo>(),
        28usize,
        concat!("Size of: ", stringify!(tagQueueInfo))
    );
    assert_eq!(
        ::std::mem::align_of::<tagQueueInfo>(),
        4usize,
        concat!("Alignment of ", stringify!(tagQueueInfo))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagQueueInfo>())).queueID as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(tagQueueInfo),
            "::",
            stringify!(queueID)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagQueueInfo>())).queueLen as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(tagQueueInfo),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagQueueInfo>())).queueSize as *const _ as usize },
        6usize,
        concat!(
            "Offset of field: ",
            stringify!(tagQueueInfo),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagQueueInfo>())).queueHead as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(tagQueueInfo),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagQueueInfo>())).queueTail as *const _ as usize },
        10usize,
        concat!(
            "Offset of field: ",
            stringify!(tagQueueInfo),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagQueueInfo>())).writableCnt as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(tagQueueInfo),
            "::",
            stringify!(writableCnt)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagQueueInfo>())).readableCnt as *const _ as usize },
        14usize,
        concat!(
            "Offset of field: ",
            stringify!(tagQueueInfo),
            "::",
            stringify!(readableCnt)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagQueueInfo>())).waitReadTask as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(tagQueueInfo),
            "::",
            stringify!(waitReadTask)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagQueueInfo>())).waitWriteTask as *const _ as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(tagQueueInfo),
            "::",
            stringify!(waitWriteTask)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagQueueInfo>())).waitMemTask as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(tagQueueInfo),
            "::",
            stringify!(waitMemTask)
        )
    );
}
#[doc = " @ingroup los_queue"]
...
extern "C" {
    #[doc = " @ingroup los_queue"]
    #[doc = " @brief Create a message queue."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to create a message queue."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>There are LOSCFG_BASE_IPC_QUEUE_LIMIT queues available, change it's value when necessary.</li>"]
    #[doc = " </ul>"]
    #[doc = " @param queueName        [IN]    Message queue name."]
    #[doc = " @param len              [IN]    Queue length. The value range is [1,0xffff]."]
    #[doc = " @param queueID          [OUT]   ID of the queue control structure that is successfully created."]
    #[doc = " @param flags            [IN]    Queue mode. Reserved parameter, not used for now."]
    #[doc = " @param maxMsgSize       [IN]    Node size. The value range is [1,0xffff-4]."]
    #[doc = ""]
    #[doc = " @retval   #LOS_OK                               The message queue is successfully created."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_CB_UNAVAILABLE       The upper limit of the number of created queues is exceeded."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_CREATE_NO_MEMORY     Insufficient memory for queue creation."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_CREAT_PTR_NULL       Null pointer, queueID is NULL."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_PARA_ISZERO          The queue length or message node size passed in during queue"]
    #[doc = " creation is 0."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_SIZE_TOO_BIG         The parameter maxMsgSize is larger than 0xffff - 4."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_queue.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_QueueDelete"]
...
extern "C" {
    #[doc = " @ingroup los_queue"]
    #[doc = " @brief Create a static message queue."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to create a message queue using static memory for data storage."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>There are LOSCFG_BASE_IPC_QUEUE_LIMIT queues available, change it's value when necessary.</li>"]
    #[doc = " </ul>"]
    ...
    #[doc = " @param len              [IN]    Queue length. The value range is [1,0xffff]."]
    #[doc = " @param queueID          [OUT]   ID of the queue control structure that is successfully created."]
    #[doc = " @param staticMem        [IN]    Pointer to a static memory for the message queue data."]
    #[doc = " @param flags            [IN]    Queue mode. Reserved parameter, not used for now."]
    #[doc = " @param maxMsgSize       [IN]    Node size. The value range is [1,0xffff-4]."]
    #[doc = ""]
    #[doc = " @retval   #LOS_OK                               The message queue is successfully created."]
...
extern "C" {
    #[doc = " @ingroup los_queue"]
    #[doc = " @brief Read a queue."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to read data in a specified queue, and store the obtained data to the address specified"]
    #[doc = " by bufferAddr. The address and the size of the data to be read are defined by users."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specific queue should be created firstly.</li>"]
    #[doc = " <li>Queue reading adopts the fist in first out (FIFO) mode. The data that is first stored in the queue is read"]
    #[doc = " first.</li>"]
    #[doc = " <li>bufferAddr stores the obtained data.</li>"]
    #[doc = " <li>Do not read or write a queue in unblocking modes such as an interrupt.</li>"]
    #[doc = " <li>This API cannot be called before the kernel is initialized.</li>"]
    #[doc = " <li>The argument timeOut is a relative time.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param queueID        [IN]     Queue ID created by LOS_QueueCreate. The value range is"]
    #[doc = " [1,LOSCFG_BASE_IPC_QUEUE_LIMIT]."]
    #[doc = " @param bufferAddr     [OUT]    Starting address that stores the obtained data. The starting address must not be"]
    #[doc = " null."]
    #[doc = " @param bufferSize     [IN/OUT] Where to maintain the buffer expected-size before read, and the real-size after read."]
    #[doc = " @param timeOut        [IN]     Expiry time. The value range is [0,LOS_WAIT_FOREVER](unit: Tick)."]
    #[doc = ""]
    #[doc = " @retval   #LOS_OK                              The queue is successfully read."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_INVALID             The handle of the queue that is being read is invalid."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_READ_PTR_NULL       The pointer passed in during queue reading is null."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_READSIZE_ISZERO     The buffer size passed in during queue reading is 0."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_READ_IN_INTERRUPT   The queue cannot be read during an interrupt when the time for"]
    #[doc = " waiting to processing the queue expires."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_NOT_CREATE          The queue to be read is not created."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_ISEMPTY             No resource is in the queue that is being read when the time for"]
    #[doc = " waiting to processing the queue expires."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_PEND_IN_LOCK        The task is forbidden to be blocked on a queue when the task is"]
    #[doc = " locked."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_TIMEOUT             The time set for waiting to processing the queue expires."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_READ_SIZE_TOO_SMALL The buffer size passed in during queue reading is less than"]
    #[doc = " the queue size."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_queue.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_QueueWriteCopy | LOS_QueueCreate"]
...
extern "C" {
    #[doc = " @ingroup los_queue"]
    #[doc = " @brief Write data into a queue."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to write the data of the size specified by bufferSize and stored at the address specified by"]
    #[doc = " bufferAddr into a queue."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specific queue should be created firstly.</li>"]
    #[doc = " <li>Do not read or write a queue in unblocking modes such as interrupt.</li>"]
    #[doc = " <li>This API cannot be called before the kernel is initialized.</li>"]
    #[doc = " <li>The data to be written is of the size specified by bufferSize and is stored at the address specified by"]
    #[doc = " BufferAddr.</li>"]
    #[doc = " <li>The argument timeOut is a relative time.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param queueID        [IN]        Queue ID created by LOS_QueueCreate. The value range is"]
    #[doc = " [1,LOSCFG_BASE_IPC_QUEUE_LIMIT]."]
    #[doc = " @param bufferAddr     [IN]        Starting address that stores the data to be written.The starting address must"]
    #[doc = " not be null."]
    #[doc = " @param bufferSize     [IN]        Passed-in buffer size. The value range is [1,USHRT_MAX - sizeof(UINT32)]."]
    #[doc = " @param timeOut        [IN]        Expiry time. The value range is [0,LOS_WAIT_FOREVER](unit: Tick)."]
    #[doc = ""]
    #[doc = " @retval   #LOS_OK                                 The data is successfully written into the queue."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_INVALID                The queue handle passed in during queue writing is invalid."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_WRITE_PTR_NULL         The pointer passed in during queue writing is null."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_WRITESIZE_ISZERO       The buffer size passed in during queue writing is 0."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_WRITE_IN_INTERRUPT     The queue cannot be written during an interrupt when the time"]
    #[doc = " for waiting to processing the queue expires."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_NOT_CREATE             The queue into which the data is written is not created."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_WRITE_SIZE_TOO_BIG     The buffer size passed in during queue writing is bigger than"]
    #[doc = " the queue size."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_ISFULL                 No free node is available during queue writing."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_PEND_IN_LOCK           The task is forbidden to be blocked on a queue when"]
    #[doc = " the task is locked."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_TIMEOUT                The time set for waiting to processing the queue expires."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_queue.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_QueueReadCopy | LOS_QueueCreate"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to read the address of data in a specified queue, and store it to the address specified by"]
    #[doc = " bufferAddr."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specific queue should be created firstly.</li>"]
    #[doc = " <li>Queue reading adopts the fist in first out (FIFO) mode. The data that is first stored in the queue is"]
    #[doc = " read first.</li>"]
    #[doc = " <li>bufferAddr stores the obtained data address.</li>"]
    #[doc = " <li>Do not read or write a queue in unblocking modes such as an interrupt.</li>"]
    #[doc = " <li>This API cannot be called before the kernel is initialized.</li>"]
    #[doc = " <li>The argument timeOut is a relative time.</li>"]
    #[doc = " <li>The bufferSize is not really used in LOS_QueueRead, because the interface is only used to"]
    #[doc = " obtain the address of data.</li>"]
    #[doc = " <li>The buffer which the bufferAddr pointing to must be greater than or equal to 4 bytes.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param queueID        [IN]        Queue ID created by LOS_QueueCreate. The value range is"]
    #[doc = " [1,LOSCFG_BASE_IPC_QUEUE_LIMIT]."]
    #[doc = " @param bufferAddr     [OUT]       Starting address that stores the obtained data. The starting address must"]
    #[doc = " not be null."]
    #[doc = " @param bufferSize     [IN]        Passed-in buffer size, which must not be 0. The value range is [1,0xffffffff]."]
    #[doc = " @param timeOut        [IN]        Expiry time. The value range is [0,LOS_WAIT_FOREVER](unit: Tick)."]
    #[doc = ""]
    #[doc = " @retval   #LOS_OK                               The queue is successfully read."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_INVALID              The handle of the queue that is being read is invalid."]
    ...
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_queue.h: The header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_QueueWrite | LOS_QueueCreate"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to write the address of data specified by bufferAddr into a queue."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specific queue should be created firstly.</li>"]
    #[doc = " <li>Do not read or write a queue in unblocking modes such as an interrupt.</li>"]
    #[doc = " <li>This API cannot be called before the kernel is initialized.</li>"]
    #[doc = " <li>The address of the data of the size specified by bufferSize and stored at the address specified by"]
    #[doc = " BufferAddr is to be written.</li>"]
    #[doc = " <li>The argument timeOut is a relative time.</li>"]
    #[doc = " <li>The bufferSize is not really used in LOS_QueueWrite, because the interface is only used to write the address"]
    #[doc = " of data specified by bufferAddr into a queue.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param queueID        [IN]        Queue ID created by LOS_QueueCreate. The value range is"]
    #[doc = " [1,LOSCFG_BASE_IPC_QUEUE_LIMIT]."]
    #[doc = " @param bufferAddr     [IN]        Starting address that stores the data to be written. The starting address"]
    ...
    #[doc = " @retval   #LOS_ERRNO_QUEUE_WRITE_PTR_NULL        The pointer passed in during queue writing is null."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_WRITESIZE_ISZERO      The buffer size passed in during queue writing is 0."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_WRITE_IN_INTERRUPT    The queue cannot be written during an interrupt when the time for"]
    #[doc = " waiting to processing the queue expires."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_NOT_CREATE            The queue into which the data is written is not created."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_WRITE_SIZE_TOO_BIG    The buffer size passed in during queue writing is bigger than"]
    #[doc = " the queue size."]
    ...
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_queue.h: The header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_QueueRead | LOS_QueueCreate"]
...
extern "C" {
    #[doc = " @ingroup los_queue"]
    #[doc = " @brief Write data into a queue header."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to write the data of the size specified by bufferSize and stored at the address specified by"]
    #[doc = " bufferAddr into a queue header."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>Do not read or write a queue in unblocking modes such as an interrupt.</li>"]
    #[doc = " <li>This API cannot be called before the kernel is initialized.</li>"]
    ...
    #[doc = " BufferAddr is to be written.</li>"]
    #[doc = " <li>The argument timeOut is a relative time.</li>"]
    #[doc = " <li>LOS_QueueRead and LOS_QueueWriteHead are a set of interfaces, and the two groups of interfaces need to be used."]
    #[doc = " <li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param queueID        [IN]        Queue ID created by LOS_QueueCreate. The value range is"]
    #[doc = " [1,LOSCFG_BASE_IPC_QUEUE_LIMIT]."]
    #[doc = " @param bufferAddr     [OUT]       Starting address that stores the data to be written. The starting address"]
    #[doc = " must not be null."]
    #[doc = " @param bufferSize     [IN]        Passed-in buffer size, which must not be 0. The value range is [1,0xffffffff]."]
    #[doc = " @param timeOut        [IN]        Expiry time. The value range is [0,LOS_WAIT_FOREVER](unit: Tick)."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = " BufferAddr is to be written.</li>"]
    #[doc = " <li>The argument timeOut is a relative time.</li>"]
    #[doc = " <li>LOS_QueueRead and LOS_QueueWriteHead are a set of interfaces, and the two groups of interfaces need to be"]
    #[doc = " used.<li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param queueID        [IN]        Queue ID created by LOS_QueueCreate. The value range is"]
    #[doc = " [1,LOSCFG_BASE_IPC_QUEUE_LIMIT]."]
    #[doc = " @param bufferAddr     [OUT]       Starting address that stores the data to be written."]
    #[doc = " The starting address must not be null."]
    #[doc = " @param bufferSize     [IN]        Passed-in buffer size, which must not be 0. The value range is [1,0xffffffff]."]
    #[doc = " @param timeOut        [IN]        Expiry time. The value range is [0,LOS_WAIT_FOREVER](unit: Tick)."]
    #[doc = ""]
    #[doc = " @retval   #LOS_OK                                 The data is successfully written into the queue."]
    ...
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_queue.h: The header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_QueueWrite | LOS_QueueWriteHead"]
...
extern "C" {
    #[doc = " @ingroup los_queue"]
    #[doc = " @brief Delete a queue."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to delete a queue."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>This API cannot be used to delete a queue that is not created.</li>"]
    #[doc = " <li>A synchronous queue fails to be deleted if any tasks are blocked on it, or some queues are being read or"]
    #[doc = " written.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param queueID     [IN]      Queue ID created by LOS_QueueCreate. The value range is"]
    #[doc = " [1,LOSCFG_BASE_IPC_QUEUE_LIMIT]."]
    #[doc = ""]
    #[doc = " @retval   #LOS_OK                           The queue is successfully deleted."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_NOT_FOUND        The queue cannot be found."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_NOT_CREATE       The queue handle passed in when the queue is being deleted is"]
    #[doc = " incorrect."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_IN_TSKUSE        The queue that blocks a task cannot be deleted."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_IN_TSKWRITE      Queue reading and writing are not synchronous."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_queue.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_QueueCreate | LOS_QueueCreate"]
    pub fn LOS_QueueDelete(queueID: UINT32) -> UINT32;
}
extern "C" {
    #[doc = " @ingroup los_queue"]
    #[doc = " @brief Obtain queue information."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to obtain queue information."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specific queue should be created firstly.</li>"]
    #[doc = " </ul>"]
    #[doc = " @param queueID       [IN]        Queue ID created by LOS_QueueCreate. The value range is"]
    #[doc = " [1,LOSCFG_BASE_IPC_QUEUE_LIMIT]."]
    #[doc = " @param queueInfo     [OUT]       The queue information to be read must not be null."]
    #[doc = ""]
    #[doc = " @retval   #LOS_OK                            The queue information is successfully obtained."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_PTR_NULL          The pointer to the queue information to be obtained is null."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_INVALID           The handle of the queue that is being read is invalid."]
    #[doc = " @retval   #LOS_ERRNO_QUEUE_NOT_CREATE        The queue in which the information to be obtained is stored is"]
    #[doc = " not created."]
    #[doc = ""]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_queue.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_QueueCreate"]
...
#[doc = " @ingroup los_queue"]
#[doc = " Queue information block structure"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct LosQueueCB {
    ...
    #[doc = "0:readlist, 1:writelist"]
    pub readWriteList: [LOS_DL_LIST; 2usize],
    #[doc = "< Pointer to the memory linked list"]
    pub memList: LOS_DL_LIST,
}
#[test]
fn bindgen_test_layout_LosQueueCB() {
    assert_eq!(
        ::std::mem::size_of::<LosQueueCB>(),
        80usize,
        concat!("Size of: ", stringify!(LosQueueCB))
    );
    assert_eq!(
        ::std::mem::align_of::<LosQueueCB>(),
        8usize,
        concat!("Alignment of ", stringify!(LosQueueCB))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosQueueCB>())).queue as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(LosQueueCB),
            "::",
            stringify!(queue)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosQueueCB>())).queueName as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(LosQueueCB),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosQueueCB>())).queueState as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(LosQueueCB),
            "::",
            stringify!(queueState)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosQueueCB>())).queueLen as *const _ as usize },
        18usize,
        concat!(
            "Offset of field: ",
            stringify!(LosQueueCB),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosQueueCB>())).queueSize as *const _ as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(LosQueueCB),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosQueueCB>())).queueID as *const _ as usize },
        22usize,
        concat!(
            "Offset of field: ",
            stringify!(LosQueueCB),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosQueueCB>())).queueHead as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(LosQueueCB),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosQueueCB>())).queueTail as *const _ as usize },
        26usize,
        concat!(
            "Offset of field: ",
            stringify!(LosQueueCB),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosQueueCB>())).readWriteableCnt as *const _ as usize },
        28usize,
        concat!(
            "Offset of field: ",
            stringify!(LosQueueCB),
            "::",
            stringify!(readWriteableCnt)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosQueueCB>())).readWriteList as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(LosQueueCB),
            "::",
            stringify!(readWriteList)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosQueueCB>())).memList as *const _ as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(LosQueueCB),
...
extern "C" {
    #[doc = "  @ingroup los_queue"]
    #[doc = "  Queue information control block"]
    pub static mut g_allQueue: *mut LosQueueCB;
}
extern "C" {
    #[doc = " @ingroup los_queue"]
    #[doc = " @brief Alloc a stationary memory for a mail."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to alloc a stationary memory for a mail according to queueID."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>Do not alloc memory in unblocking modes such as interrupt.</li>"]
    #[doc = " <li>This API cannot be called before the kernel is initialized.</li>"]
    #[doc = " <li>The argument timeOut is a relative time.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param queueID        [IN]        Queue ID. The value range is [1,LOSCFG_BASE_IPC_QUEUE_LIMIT]."]
    #[doc = " @param mailPool       [IN]        The memory poll that stores the mail."]
    #[doc = " @param timeOut        [IN]        Expiry time. The value range is [0,LOS_WAIT_FOREVER]."]
    #[doc = ""]
    #[doc = " @retval   #NULL                    The memory allocation is failed."]
    #[doc = " @retval   #mem                     The address of alloc memory."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_queue.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see OsQueueMailFree"]
...
extern "C" {
    #[doc = " @ingroup los_queue"]
    #[doc = " @brief Free a stationary memory of a mail."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to free a stationary memory for a mail according to queueID."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>This API cannot be called before the kernel is initialized.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param queueID         [IN]        Queue ID. The value range is [1,LOSCFG_BASE_IPC_QUEUE_LIMIT]."]
    #[doc = " @param mailPool        [IN]        The mail memory poll address."]
    #[doc = " @param mailMem         [IN]        The mail memory block address."]
    #[doc = ""]
    #[doc = " @retval   #LOS_OK                                 0x00000000: The memory free successfully."]
    #[doc = " @retval   #OS_ERRNO_QUEUE_MAIL_HANDLE_INVALID     0x02000619: The handle of the queue passed-in when the memory for"]
    #[doc = "the queue is being freed is invalid."]
    #[doc = " @retval   #OS_ERRNO_QUEUE_MAIL_PTR_INVALID        0x0200061a: The pointer to the memory to be freed is null."]
    #[doc = " @retval   #OS_ERRNO_QUEUE_MAIL_FREE_ERROR         0x0200061b: The memory for the queue fails to be freed."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_queue.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see OsQueueMailAlloc"]
...
extern "C" {
    #[doc = " @ingroup los_queue"]
    #[doc = " @brief Initialization queue."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to initialization queue."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>None.</li>"]
    #[doc = " </ul>"]
...
extern "C" {
    #[doc = " @ingroup los_queue"]
    #[doc = " @brief Handle when read or write queue."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to handle when read or write queue."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>None.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param queueID        [IN]       Queue id."]
    #[doc = " @param operateType    [IN]       Operate type"]
    #[doc = " @param bufferAddr     [IN]       Buffer address."]
    #[doc = " @param bufferSize     [IN]       Buffer size."]
    #[doc = " @param timeOut        [IN]       Timeout."]
    #[doc = ""]
    #[doc = " @retval   UINT32  Handle result."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_queue.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see None."]
...
extern "C" {
    #[doc = " @ingroup los_sem"]
    #[doc = " @brief Create a Counting semaphore."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to create a semaphore control structure according to the initial number of available semaphores"]
    #[doc = " specified by count and return the ID of this semaphore control structure."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>None.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param count       [IN]  Initial number of available semaphores. The value range is [0, OS_SEM_COUNTING_MAX_COUNT)."]
    #[doc = " @param semHandle   [OUT] ID of the semaphore control structure that is initialized."]
    #[doc = ""]
    #[doc = " @retval #LOS_ERRNO_SEM_PTR_NULL     The passed-in semHandle value is NULL."]
    #[doc = " @retval #LOS_ERRNO_SEM_OVERFLOW     The passed-in count value is greater than the maximum number of available"]
    #[doc = " semaphores."]
    #[doc = " @retval #LOS_ERRNO_SEM_ALL_BUSY     No semaphore control structure is available."]
    #[doc = " @retval #LOS_OK   The semaphore is successfully created."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_sem.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_SemDelete"]
    pub fn LOS_SemCreate(count: UINT16, semHandle: *mut UINT32) -> UINT32;
}
extern "C" {
    #[doc = " @ingroup los_sem"]
    #[doc = " @brief Create a binary semaphore."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to create a binary semaphore control structure according to the initial number of available"]
    #[doc = " semaphores specified by count and return the ID of this semaphore control structure."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>None.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param count        [IN]  Initial number of available semaphores. The value range is [0, 1]."]
    #[doc = " @param semHandle    [OUT] ID of the semaphore control structure that is initialized."]
    #[doc = ""]
    #[doc = " @retval #LOS_ERRNO_SEM_PTR_NULL     The passed-in semHandle value is NULL."]
    #[doc = " @retval #LOS_ERRNO_SEM_OVERFLOW     The passed-in count value is greater than the maximum number of available"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to delete a semaphore control structure that has an ID specified by semHandle."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specified sem id must be created first. </li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param semHandle   [IN] ID of the semaphore control structure to be deleted. The ID of the semaphore"]
    #[doc = " control structure is obtained from semaphore creation."]
    #[doc = ""]
    #[doc = " @retval #LOS_ERRNO_SEM_INVALID  The passed-in semHandle value is invalid."]
    #[doc = " @retval #LOS_ERRNO_SEM_PENDED   The queue of the tasks that are waiting on the semaphore control structure is"]
    #[doc = " not null."]
    #[doc = " @retval #LOS_OK   The semaphore control structure is successfully deleted."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_sem.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_SemCreate"]
    pub fn LOS_SemDelete(semHandle: UINT32) -> UINT32;
}
extern "C" {
    #[doc = " @ingroup los_sem"]
    #[doc = " @brief Request a semaphore."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to request a semaphore based on the semaphore control structure ID specified by semHandle and the"]
    #[doc = " parameter that specifies the timeout period."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specified sem id must be created first. </li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param semHandle   [IN] ID of the semaphore control structure to be requested. The ID of the semaphore control"]
    #[doc = " structure is obtained from semaphore creation."]
    #[doc = " @param timeout     [IN] Timeout interval for waiting on the semaphore. The value range is [0, 0xFFFFFFFF]."]
    #[doc = " If the value is set to 0, the semaphore is not waited on. If the value is set to 0xFFFFFFFF,"]
    #[doc = " the semaphore is waited on forever(unit: Tick)."]
    #[doc = ""]
    #[doc = " @retval #LOS_ERRNO_SEM_INVALID          The passed-in semHandle value is invalid."]
    #[doc = " @retval #LOS_ERRNO_SEM_UNAVAILABLE      There is no available semaphore resource."]
    #[doc = " @retval #LOS_ERRNO_SEM_PEND_INTERR      The API is called during an interrupt, which is forbidden."]
    #[doc = " @retval #LOS_ERRNO_SEM_PEND_IN_LOCK     The task is unable to request a semaphore because task scheduling is locked."]
    #[doc = " @retval #LOS_ERRNO_SEM_TIMEOUT\t The request for the semaphore times out."]
    #[doc = " @retval #LOS_OK   The semaphore request succeeds."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_sem.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_SemPost | LOS_SemCreate"]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to release a semaphore that has a semaphore control structure ID specified by semHandle."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specified sem id must be created first. </li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param semHandle   [IN] ID of the semaphore control structure to be released.The ID of the semaphore control"]
    #[doc = " structure is obtained from semaphore creation."]
    #[doc = ""]
    #[doc = " @retval #LOS_ERRNO_SEM_INVALID      The passed-in semHandle value is invalid."]
    #[doc = " @retval #LOS_ERRNO_SEM_OVERFLOW     The times of semaphore release exceed the maximum times permitted."]
    #[doc = " @retval #LOS_OK                     The semaphore is successfully released."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_sem.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_SemPend | LOS_SemCreate"]
...
#[doc = " @ingroup los_sem"]
#[doc = " Semaphore control structure."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct LosSemCB {
    #[doc = "< Semaphore state"]
...
#[test]
fn bindgen_test_layout_LosSemCB() {
    assert_eq!(
        ::std::mem::size_of::<LosSemCB>(),
        24usize,
        concat!("Size of: ", stringify!(LosSemCB))
    );
    assert_eq!(
        ::std::mem::align_of::<LosSemCB>(),
        8usize,
        concat!("Alignment of ", stringify!(LosSemCB))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosSemCB>())).semStat as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(LosSemCB),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosSemCB>())).semCount as *const _ as usize },
        2usize,
        concat!(
            "Offset of field: ",
            stringify!(LosSemCB),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosSemCB>())).maxSemCount as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(LosSemCB),
            "::",
            stringify!(maxSemCount)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosSemCB>())).semID as *const _ as usize },
        6usize,
        concat!(
            "Offset of field: ",
            stringify!(LosSemCB),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<LosSemCB>())).semList as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(LosSemCB),
...
extern "C" {
    #[doc = " @ingroup los_sem"]
    #[doc = " @brief Initialize the  Semaphore doubly linked list."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to initialize the  Semaphore doubly linked list."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>None.</li>"]
    #[doc = " </ul>"]
...
extern "C" {
    #[doc = " @ingroup los_sem"]
    #[doc = " @brief Create Semaphore."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to create Semaphore."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>None.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param  count      [IN]Type  #UINT16 Semaphore count."]
    #[doc = " @param  maxCount   [IN]Type  #UINT16 Max semaphore count."]
    #[doc = " @param  semHandle  [OUT]Type #UINT32 * Index of semaphore."]
    #[doc = ""]
    #[doc = " @retval UINT32   Create result."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_sem.h: the header file that contains the API declaration.</li></ul>"]
...
#[doc = " Software timer mode"]
pub type EnSwTmrType = ::std::os::raw::c_uint;
#[doc = " @ingroup  los_swtmr"]
#[doc = " @brief Define the type of a callback function that handles software timer timeout."]
#[doc = ""]
#[doc = " @par Description:"]
#[doc = " This API is used to define the type of a callback function that handles software timer timeout, so that it can be"]
#[doc = " called when software timer timeout."]
#[doc = ""]
#[doc = " @attention"]
#[doc = " <ul>"]
#[doc = " <li>None.</li>"]
#[doc = " </ul>"]
#[doc = ""]
#[doc = " @param  para     [IN] the parameter of the callback function that handles software timer timeout."]
#[doc = ""]
#[doc = " @retval None."]
#[doc = " @par Dependency:"]
#[doc = " <ul><li>los_swtmr.h: the header file that contains the API declaration.</li></ul>"]
#[doc = " @see None."]
pub type SWTMR_PROC_FUNC = ::std::option::Option<unsafe extern "C" fn(para: UINT32)>;
#[doc = " @ingroup los_swtmr"]
#[doc = " Software timer control structure"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[test]
fn bindgen_test_layout_tagSwTmrCtrl() {
    assert_eq!(
        ::std::mem::size_of::<tagSwTmrCtrl>(),
        64usize,
        concat!("Size of: ", stringify!(tagSwTmrCtrl))
    );
    assert_eq!(
        ::std::mem::align_of::<tagSwTmrCtrl>(),
        8usize,
        concat!("Alignment of ", stringify!(tagSwTmrCtrl))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagSwTmrCtrl>())).pstNext as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(tagSwTmrCtrl),
            "::",
            stringify!(pstNext)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagSwTmrCtrl>())).ucState as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(tagSwTmrCtrl),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagSwTmrCtrl>())).ucMode as *const _ as usize },
        9usize,
        concat!(
            "Offset of field: ",
            stringify!(tagSwTmrCtrl),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagSwTmrCtrl>())).ucOverrun as *const _ as usize },
        10usize,
        concat!(
            "Offset of field: ",
            stringify!(tagSwTmrCtrl),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagSwTmrCtrl>())).usTimerID as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(tagSwTmrCtrl),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagSwTmrCtrl>())).uwInterval as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(tagSwTmrCtrl),
            "::",
            stringify!(uwInterval)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagSwTmrCtrl>())).uwArg as *const _ as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(tagSwTmrCtrl),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagSwTmrCtrl>())).pfnHandler as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(tagSwTmrCtrl),
            "::",
            stringify!(pfnHandler)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagSwTmrCtrl>())).stSortList as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(tagSwTmrCtrl),
            "::",
            stringify!(stSortList)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tagSwTmrCtrl>())).startTime as *const _ as usize },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(tagSwTmrCtrl),
...
extern "C" {
    #[doc = " @ingroup los_swtmr"]
    #[doc = " @brief Start a software timer."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to start a software timer that has a specified ID."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specific timer must be created first</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param  swtmrID  [IN] Software timer ID created by LOS_SwtmrCreate."]
    #[doc = ""]
    #[doc = " @retval #LOS_ERRNO_SWTMR_ID_INVALID       Invalid software timer ID."]
    #[doc = " @retval #LOS_ERRNO_SWTMR_NOT_CREATED      The software timer is not created."]
    #[doc = " @retval #LOS_ERRNO_SWTMR_STATUS_INVALID   Invalid software timer state."]
    #[doc = " @retval #LOS_OK                           The software timer is successfully started."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_swtmr.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_SwtmrStop | LOS_SwtmrCreate"]
    pub fn LOS_SwtmrStart(swtmrID: UINT32) -> UINT32;
}
extern "C" {
    #[doc = " @ingroup los_swtmr"]
    #[doc = " @brief Stop a software timer."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to stop a software timer that has a specified ID."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specific timer should be created and started firstly.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param  swtmrID  [IN] Software timer ID created by LOS_SwtmrCreate."]
    #[doc = ""]
    #[doc = " @retval #LOS_ERRNO_SWTMR_ID_INVALID       Invalid software timer ID."]
    #[doc = " @retval #LOS_ERRNO_SWTMR_NOT_CREATED      The software timer is not created."]
    #[doc = " @retval #LOS_ERRNO_SWTMR_NOT_STARTED      The software timer is not started."]
    #[doc = " @retval #LOS_ERRNO_SWTMR_STATUS_INVALID   Invalid software timer state."]
    #[doc = " @retval #LOS_OK                           The software timer is successfully stopped."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_swtmr.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_SwtmrStart | LOS_SwtmrCreate"]
    pub fn LOS_SwtmrStop(swtmrID: UINT32) -> UINT32;
}
extern "C" {
    #[doc = " @ingroup los_swtmr"]
    #[doc = " @brief Obtain the number of remaining Ticks configured on a software timer."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to obtain the number of remaining Ticks configured on the software timer of which the ID is"]
    #[doc = " specified by usSwTmrID."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specific timer should be created and started successfully, error happens otherwise.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param  swtmrID  [IN]  Software timer ID created by LOS_SwtmrCreate."]
    #[doc = " @param  tick     [OUT] Number of remaining Ticks configured on the software timer."]
    #[doc = ""]
    #[doc = " @retval #LOS_ERRNO_SWTMR_ID_INVALID      Invalid software timer ID."]
    #[doc = " @retval #LOS_ERRNO_SWTMR_NOT_CREATED     The software timer is not created."]
    #[doc = " @retval #LOS_ERRNO_SWTMR_NOT_STARTED     The software timer is not started."]
    #[doc = " @retval #LOS_ERRNO_SWTMR_STATUS_INVALID  Invalid software timer state."]
    #[doc = " @retval #LOS_OK                          The number of remaining Ticks is successfully obtained."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_swtmr.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_SwtmrCreate"]
...
extern "C" {
    #[doc = " @ingroup los_swtmr"]
    #[doc = " @brief Delete a software timer."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " This API is used to delete a software timer."]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>The specific timer should be created and then stopped firstly.</li>"]
    #[doc = " </ul>"]
    #[doc = ""]
    #[doc = " @param  swtmrID     [IN] Software timer ID created by LOS_SwtmrCreate."]
    #[doc = ""]
    ...
    #[doc = " @retval #LOS_ERRNO_SWTMR_NOT_CREATED       The software timer is not created."]
    #[doc = " @retval #LOS_ERRNO_SWTMR_STATUS_INVALID    Invalid software timer state."]
    #[doc = " @retval #LOS_OK                            The software timer is successfully deleted."]
    #[doc = " @par Dependency:"]
    #[doc = " <ul><li>los_swtmr.h: the header file that contains the API declaration.</li></ul>"]
    #[doc = " @see LOS_SwtmrCreate"]
...
#[doc = " @ingroup los_swtmr"]
#[doc = " Software timer state"]
pub type SwtmrState = ::std::os::raw::c_uint;
#[doc = " @ingroup los_swtmr"]
#[doc = " Structure of the callback function that handles software timer timeout"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct SwtmrHandlerItem {
    ...
    #[doc = "that handles software timer timeout is called"]
    pub arg: UINT32,
    #[doc = "< The id used to obtain the software timer handle"]
    pub swtmrID: UINT32,
}
#[test]
fn bindgen_test_layout_SwtmrHandlerItem() {
    assert_eq!(
        ::std::mem::size_of::<SwtmrHandlerItem>(),
        16usize,
        concat!("Size of: ", stringify!(SwtmrHandlerItem))
    );
    assert_eq!(
        ::std::mem::align_of::<SwtmrHandlerItem>(),
        8usize,
        concat!("Alignment of ", stringify!(SwtmrHandlerItem))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<SwtmrHandlerItem>())).handler as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(SwtmrHandlerItem),
            "::",
            stringify!(handler)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<SwtmrHandlerItem>())).arg as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(SwtmrHandlerItem),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<SwtmrHandlerItem>())).swtmrID as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(SwtmrHandlerItem),
...
extern "C" {
    #[doc = " @ingroup los_swtmr"]
    #[doc = " @brief Initialization software timer."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " <ul>"]
    #[doc = " <li>This API is used to initialization software.</li>"]
    #[doc = " </ul>"]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>None.</li>"]
...
extern "C" {
    #[doc = " @ingroup los_swtmr"]
    #[doc = " @brief Get next timeout."]
    #[doc = ""]
    #[doc = " @par Description:"]
    #[doc = " <ul>"]
    #[doc = " <li>This API is used to get next timeout.</li>"]
    #[doc = " </ul>"]
    #[doc = " @attention"]
    #[doc = " <ul>"]
    #[doc = " <li>None.</li>"]
